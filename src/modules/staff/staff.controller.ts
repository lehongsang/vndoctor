...
export class StaffController {
  ...
  @Doc({
    ...
    description:
      'VNDOCTOR_ADMIN hoặc FacilityAdmin tạo tài khoản cho bác sĩ/nhân sự/admin cơ sở con. Email là bắt buộc, mật khẩu mặc định hệ thống tự khởi tạo là vndoctor123.',
